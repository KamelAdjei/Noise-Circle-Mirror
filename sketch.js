...
//  ellipse(x1/1.2, y1, diameter, diameter);
  //ellipse(x1/1.2, y1*1.5, diameter, diameter);
 //ellipse(x1/1.2*1.5,y1,diameter,diameter);
//  ellipse(x1/1.2*1.5,y1*1.5,diameter,diameter);
}
